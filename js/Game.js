class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 110, y: height - 1200, image: obstacle2Image },
      { x: width / 2 + 210, y: height - 1100, image: obstacle2Image },
      { x: width / 2, y: height - 5300, image: obstacle2Image },
     
      { x: width / 2 - 110, y: height - 3300, image: obstacle2mage },
      { x: width / 2 - 110, y: height - 8000, image: obstacle2mage },
      { x: width / 2 + 110, y: height - 4300, image: obstacle2mage },
      { x: width / 2 + 110, y: height - 6600, image: obstacle2mage }
    ];
